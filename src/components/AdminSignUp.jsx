...
function AdminSignUp() {
    ...
    return(
        ...
        <>
        <div>
      <h1 className="max-w-xl mt-20 mb-0 rounded-t-lg mx-auto bg-blue-300 p-3 text-2xl my-10 font-semibold text-center text-dark-blue mb-6" style={{ marginBottom: "-1px" }}>Admin Signup</h1>
