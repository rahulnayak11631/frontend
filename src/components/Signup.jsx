        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          ...
          {  Cookies.get("role") === "eventprovider" && (
            <>
              ...
              <div className="relative z-0 w-full mb-5 group">
                <input type="tel" pattern="[0-9]{10}" name="phone" value={formData.phone} onChange={handleChange} id="floating_phone" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="Phone number (Ex: 123-456-7890)" required />
              </div>
              <div className="relative z-0 w-full mb-5 group">
