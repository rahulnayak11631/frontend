...
function CreateEvent(){
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post('http://localhost:8090/api/addevent', [formData], {
            headers: {
      ...
      return (
        ...
        <form className="p-4 md:p-5 rounded-lg shadow-md bg-gray-700" onSubmit={handleSubmit} style={{ maxWidth: '800px', margin: '0 auto', width: '100%' }}>
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
            ...
            <div className="col-span-1">
              <label htmlFor="maxCapacity" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Max Capacity
              </label>
              <input
                type="number"
            ...
            <div className="col-span-1">
  <label htmlFor="paymentRequired" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
    Payment Required
  </label>
  <select
    id="paymentRequired"
